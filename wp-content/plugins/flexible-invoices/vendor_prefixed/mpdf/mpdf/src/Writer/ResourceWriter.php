...
final class ResourceWriter implements \Psr\Log\LoggerAwareInterface
{
     ...
     */
    private $logger;
    public function __construct(\WPDeskFIVendor\Mpdf\Mpdf $mpdf, \WPDeskFIVendor\Mpdf\Writer\BaseWriter $writer, \WPDeskFIVendor\Mpdf\Writer\ColorWriter $colorWriter, \WPDeskFIVendor\Mpdf\Writer\FontWriter $fontWriter, \WPDeskFIVendor\Mpdf\Writer\ImageWriter $imageWriter, \WPDeskFIVendor\Mpdf\Writer\FormWriter $formWriter, \WPDeskFIVendor\Mpdf\Writer\OptionalContentWriter $optionalContentWriter, \WPDeskFIVendor\Mpdf\Writer\BackgroundWriter $backgroundWriter, \WPDeskFIVendor\Mpdf\Writer\BookmarkWriter $bookmarkWriter, \WPDeskFIVendor\Mpdf\Writer\MetadataWriter $metadataWriter, \WPDeskFIVendor\Mpdf\Writer\JavaScriptWriter $javaScriptWriter, \Psr\Log\LoggerInterface $logger)
    {
        $this->mpdf = $mpdf;
        $this->writer = $writer;
