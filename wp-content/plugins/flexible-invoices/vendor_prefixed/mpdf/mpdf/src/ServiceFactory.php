...
{
    public function getServices(\WPDeskFIVendor\Mpdf\Mpdf $mpdf, \Psr\Log\LoggerInterface $logger, $config, $restrictColorSpace, $languageToFont, $scriptToLanguage, $fontDescriptor, $bmp, $directWrite, $wmf)
    {
