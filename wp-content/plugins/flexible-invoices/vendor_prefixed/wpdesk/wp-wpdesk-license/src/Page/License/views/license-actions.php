...
<form method="POST">
    <table class="wpdesk_helper_key_table">
        <tr>
            <td><?php 
\esc_html(\__('Key:', 'flexible-invoices'));
?></td>
...
?> /></td>
        ...
        <tr>
            <td><?php 
\esc_html(\__('Email:', 'flexible-invoices'));
?></td>
...
if ($activation_status == 'Deactivated') {
    ...
    echo \esc_html(\__('Activate', 'flexible-invoices'));
    ?></button>
				<?php 
} else {
    ?>
                    <button class="wpdesk_helper_button button"><?php 
    echo \esc_html(\__('Deactivate', 'flexible-invoices'));
    ?></button>
				<?php 
}
?>
