...
use WPDeskFIVendor\WPDesk\License\LicenseManager;
use WPDeskFIVendor\WPDesk\License\Page\LicensePageActions;
use WPDeskFIVendor\WPDesk\License\PluginLicense;
use WPDeskFIVendor\WPDesk\PluginBuilder\Plugin\Hookable;
use WPDeskFIVendor\WPDesk_Plugin_Info;
/**
 * Handles License Activation Ajax requests.
 */
class AjaxHandler implements \WPDeskFIVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    ...
    public function handle_ajax_action()
    {
        ...
        $license_manager = new \WPDeskFIVendor\WPDesk\License\LicenseManager($this->plugin_info);
        ...
        $license_page_action = (new \WPDeskFIVendor\WPDesk\License\Page\LicensePageActions())->create_action($license_action, \false);
        $license_page_action->execute($plugin_info);
        $plugin_license = new \WPDeskFIVendor\WPDesk\License\PluginLicense($this->plugin_info);
        $form_content_renderer = new \WPDeskFIVendor\WPDesk\License\ActivationForm\FormContentRenderer($this->plugin_info, $license_page_action->get_errors());
