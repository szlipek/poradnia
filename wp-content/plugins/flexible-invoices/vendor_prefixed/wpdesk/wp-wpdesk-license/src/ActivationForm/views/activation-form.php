...
?>";
			let nonce = "<?php 
echo \esc_attr(\wp_create_nonce(\WPDeskFIVendor\WPDesk\License\ActivationForm\AjaxHandler::AJAX_ACTION));
?>";
			let alert_text = "<?php 
echo \esc_attr(\__('The action failed with an error: ', 'flexible-invoices'));
?>";
			let enter_license_key = "<?php 
echo \esc_attr(\__('Enter license key', 'flexible-invoices'));
?>";
