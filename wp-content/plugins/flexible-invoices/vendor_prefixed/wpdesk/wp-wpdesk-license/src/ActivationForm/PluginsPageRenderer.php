 ...
 */
class PluginsPageRenderer implements \WPDeskFIVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    /**
    ...
    public function output_render(string $plugin_file)
    {
        ...
        $form_content = new \WPDeskFIVendor\WPDesk\License\ActivationForm\Renderer($this->plugin_info);
