...
namespace WPDeskFIVendor\WPDesk\License\Changelog;

use ArrayObject;
use WPDeskFIVendor\WPDesk\License\Changelog\Parser\Line;
/**
 * Can parse changelog.
 *
...
class Parser
{
    ...
    private function get_lines()
    {
        ...
        return \array_map(function ($line) {
            return new \WPDeskFIVendor\WPDesk\License\Changelog\Parser\Line($line);
