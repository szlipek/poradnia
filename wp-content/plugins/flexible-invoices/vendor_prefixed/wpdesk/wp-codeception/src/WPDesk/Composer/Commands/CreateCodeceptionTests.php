 ...
 */
class CreateCodeceptionTests extends \WPDeskFIVendor\WPDesk\Composer\Codeception\Commands\BaseCommand
{
    use SedTrait;
    /**
     * Configure command.
    ...
    {
        if (!\copy($source, $dest)) {
            throw new \WPDeskFIVendor\Composer\Downloader\FilesystemException($exceptionMessage);
        }
    }
    /**
