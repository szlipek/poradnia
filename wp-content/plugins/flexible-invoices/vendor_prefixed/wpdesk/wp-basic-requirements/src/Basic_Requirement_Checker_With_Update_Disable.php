...
if (!\class_exists('WPDeskFIVendor\\WPDesk_Basic_Requirement_Checker')) {
...
if (!\class_exists('WPDeskFIVendor\\WPDesk_Basic_Requirement_Checker_With_Update_Disable')) {
     ...
     */
    class WPDesk_Basic_Requirement_Checker_With_Update_Disable extends \WPDeskFIVendor\WPDesk_Basic_Requirement_Checker
    {
        /**
