...
if (!\class_exists('WPDeskFIVendor\\Basic_Requirement_Checker')) {
    require_once 'Basic_Requirement_Checker.php';
}
if (!\class_exists('WPDeskFIVendor\\WPDesk_Basic_Requirement_Checker_With_Update_Disable')) {
...
class WPDesk_Basic_Requirement_Checker_Factory
{
    ...
    {
        return new \WPDeskFIVendor\WPDesk_Basic_Requirement_Checker($plugin_file, $plugin_name, $text_domain, null, null);
    }
    /**
    ...
    {
        $requirements_checker = new \WPDeskFIVendor\WPDesk_Basic_Requirement_Checker_With_Update_Disable($plugin_file, $plugin_name, $text_domain, $requirements['php'], $requirements['wp']);
