 ...
 */
class Lzw implements \WPDeskFIVendor\setasign\Fpdi\PdfParser\Filter\FilterInterface
{
    /**
     * @var null|string
     */
    ...
    public function decode($data)
    {
        if ($data[0] === "\x00" && $data[1] === "\x01") {
            throw new \WPDeskFIVendor\setasign\Fpdi\PdfParser\Filter\LzwException('LZW flavour not supported.', \WPDeskFIVendor\setasign\Fpdi\PdfParser\Filter\LzwException::LZW_FLAVOUR_NOT_SUPPORTED);
        }
        $this->initsTable();
        $this->data = $data;
