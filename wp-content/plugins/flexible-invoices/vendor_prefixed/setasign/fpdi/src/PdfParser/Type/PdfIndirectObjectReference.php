 ...
 */
class PdfIndirectObjectReference extends \WPDeskFIVendor\setasign\Fpdi\PdfParser\Type\PdfType
{
    /**
    ...
    {
        return \WPDeskFIVendor\setasign\Fpdi\PdfParser\Type\PdfType::ensureType(self::class, $value, 'Indirect reference value expected.');
    }
    /**
