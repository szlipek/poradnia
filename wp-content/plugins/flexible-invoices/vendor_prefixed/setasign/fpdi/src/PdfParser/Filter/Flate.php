 ...
 */
class Flate implements \WPDeskFIVendor\setasign\Fpdi\PdfParser\Filter\FilterInterface
{
    /**
    ...
    public function decode($data)
    {
        if ($this->extensionLoaded()) {
            ...
            throw new \WPDeskFIVendor\setasign\Fpdi\PdfParser\Filter\FlateException('To handle FlateDecode filter, enable zlib support in PHP.', \WPDeskFIVendor\setasign\Fpdi\PdfParser\Filter\FlateException::NO_ZLIB);
        }
        return $data;
    }
}
