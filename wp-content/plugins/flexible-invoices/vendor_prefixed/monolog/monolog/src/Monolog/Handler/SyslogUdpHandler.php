...
use WPDeskFIVendor\Monolog\Handler\SyslogUdp\UdpSocket;
/**
 ...
 */
class SyslogUdpHandler extends \WPDeskFIVendor\Monolog\Handler\AbstractSyslogHandler
{
    const RFC3164 = 0;
    const RFC5424 = 1;
     ...
     */
    public function __construct($host, $port = 514, $facility = \LOG_USER, $level = \WPDeskFIVendor\Monolog\Logger::DEBUG, $bubble = \true, $ident = 'php', $rfc = self::RFC5424)
    {
        parent::__construct($facility, $level, $bubble);
        $this->ident = $ident;
        $this->rfc = $rfc;
        $this->socket = new \WPDeskFIVendor\Monolog\Handler\SyslogUdp\UdpSocket($host, $port ?: 514);
    }
