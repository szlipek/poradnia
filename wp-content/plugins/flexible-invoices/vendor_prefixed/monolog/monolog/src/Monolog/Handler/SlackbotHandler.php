 ...
 */
class SlackbotHandler extends \WPDeskFIVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct($slackTeam, $token, $channel, $level = \WPDeskFIVendor\Monolog\Logger::CRITICAL, $bubble = \true)
    {
