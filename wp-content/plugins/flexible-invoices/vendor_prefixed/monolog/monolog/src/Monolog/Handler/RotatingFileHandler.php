 ...
 */
class RotatingFileHandler extends \WPDeskFIVendor\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct($filename, $maxFiles = 0, $level = \WPDeskFIVendor\Monolog\Logger::DEBUG, $bubble = \true, $filePermission = null, $useLocking = \false)
    {
        $this->filename = \WPDeskFIVendor\Monolog\Utils::canonicalizePath($filename);
