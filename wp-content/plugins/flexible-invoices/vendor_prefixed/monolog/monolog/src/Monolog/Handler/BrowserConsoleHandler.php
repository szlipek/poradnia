 ...
 */
class BrowserConsoleHandler extends \WPDeskFIVendor\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return new \WPDeskFIVendor\Monolog\Formatter\LineFormatter('[[%channel%]]{macro: autolabel} [[%level_name%]]{font-weight: bold} %message%');
    }
    /**
     * {@inheritDoc}
     */
