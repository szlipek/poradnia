...
use WPDeskFIVendor\RollbarNotifier;
use Exception;
...
class RollbarHandler extends \WPDeskFIVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct(\WPDeskFIVendor\RollbarNotifier $rollbarNotifier, $level = \WPDeskFIVendor\Monolog\Logger::ERROR, $bubble = \true)
    {
