...
use WPDeskFIVendor\PhpAmqpLib\Message\AMQPMessage;
use WPDeskFIVendor\PhpAmqpLib\Channel\AMQPChannel;
use AMQPExchange;
class AmqpHandler extends \WPDeskFIVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct($exchange, $exchangeName = 'log', $level = \WPDeskFIVendor\Monolog\Logger::DEBUG, $bubble = \true)
    {
        if ($exchange instanceof \AMQPExchange) {
            $exchange->setName($exchangeName);
        } elseif ($exchange instanceof \WPDeskFIVendor\PhpAmqpLib\Channel\AMQPChannel) {
    ...
    {
        return new \WPDeskFIVendor\PhpAmqpLib\Message\AMQPMessage((string) $data, array('delivery_mode' => 2, 'content_type' => 'application/json'));
    }
    /**
     * {@inheritDoc}
     */
